...
const GMA = () => {
  ...
  useEffect(() => {
    const fetchArticles = async () => {
      try {
        setLoading(true);
        const response = await axios.get('https://webscrape-60p1.onrender.com/api/gma/get-data');
  ...
  const navigateArticle = async (url) => {
    ...
    try {
      const response = await axios.post('https://webscrape-60p1.onrender.com/api/gma/get-page', { url });
      ...
      try {
        const response = await axios.post('https://webscrape-60p1.onrender.com/api/gma/page', { url });
