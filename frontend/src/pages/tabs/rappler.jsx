...
import loadingGif from "/public/8.gif"; // Ensure the correct path to your gif file
...
const RAPPLER = () => {
    ...
    const navigateArticle = async (url) => {
        ...
        try {
            let response = await axios.post('http://localhost:8080/api/rp/get-page', { url });
            ...
            try {
                const response = await axios.post('http://localhost:8080/api/rp/page', { url });
