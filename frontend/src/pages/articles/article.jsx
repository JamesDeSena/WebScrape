...
const Article = () => {
  ...
  useEffect(() => {
    const fetchArticles = async () => {
      try {
        const response = await axios.post('https://webscrape-60p1.onrender.com/api/gemini/get', {
  ...
  //   try {
  //     const response = await axios.post('https://webscrape-60p1.onrender.com/api/paraphrase', {
  //       text: content.__html,
  //       filePath: article.url
  //     });
  ...
  const translate = async () => {
    try {
      ...
      const response = await axios.post('https://webscrape-60p1.onrender.com/api/gemini/translate', {
